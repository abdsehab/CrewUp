...
export const EVENTS = [
  {
    ...
    organizer: { name: 'GreenTech Initiative', bio: 'Leveraging open-source hardware to monitor and restore urban ecosystems since 2019.', image: CLOUDINARY_IMAGES.org_greentech_initiative },
  },
  {
    id: 2,
    ...
    image_url: CLOUDINARY_IMAGES.event_community_network_build,
    participant_count: 3,
    ...
    organizer: { name: 'Ocean Clean AI', bio: 'Deploying tech-first solutions to connect and empower communities globally.', image: CLOUDINARY_IMAGES.org_ocean_clean_ai },
  },
  {
    id: 3,
    ...
    icon: 'terminal',
    category: 'Community Tech',
    image_url: CLOUDINARY_IMAGES.event_eco_tracker_hackathon,
    ...
    organizer: { name: 'Solar Action Network', bio: 'Bringing open-source sustainability tools to developers worldwide since 2021.', image: CLOUDINARY_IMAGES.org_solar_action_network },
  },
  {
    id: 4,
    ...
    icon: 'tree',
    category: 'Environmental',
    image_url: CLOUDINARY_IMAGES.event_watershed_restoration,
    ...
    organizer: { name: 'GreenTech Initiative', bio: 'Leveraging open-source hardware to monitor forest health and prevent illegal logging.', image: CLOUDINARY_IMAGES.org_greentech_initiative },
  },
  {
    id: 5,
    ...
    icon: 'wifi',
    category: 'Education',
    image_url: CLOUDINARY_IMAGES.event_smart_grid_workshop,
    ...
    organizer: { name: 'Solar Action Network', bio: 'Bringing sustainable energy to off-grid communities via volunteer-driven microgrid installs.', image: CLOUDINARY_IMAGES.org_solar_action_network },
  },
  {
    id: 6,
    ...
    image_url: CLOUDINARY_IMAGES.event_urban_renewal_hackathon,
    ...
    organizer: { name: 'Ocean Clean AI', bio: 'Deploying tech-first solutions to empower communities and clean our environments.', image: CLOUDINARY_IMAGES.org_ocean_clean_ai },
  },
  {
    id: 7,
    title: 'Dhanmondi Lake Cleaning Initiative',
    start_time: '2024-11-28T07:30:00Z',
    end_time: '2024-11-28T12:30:00Z',
    ...
    icon: 'leaf',
    category: 'Environmental',
    image_url: CLOUDINARY_IMAGES.event_dhanmondi_lake_cleaning,
    ...
    organizer: { name: 'Urban Roots Collective', bio: 'Fostering greener, climate-resilient cities through grassroots community stewardship.', image: CLOUDINARY_IMAGES.org_urban_roots_collective },
  },
];
